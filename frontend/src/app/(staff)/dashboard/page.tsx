    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Text style={{ fontSize: 12, fontWeight: 600, color: '#64748b' }}>VIEW PERSPECTIVE:</Text>
          <Segmented 
            options={roles} 
            value={activeRole} 
      ...
      {isLoading ? (
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12} lg={6}>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                <span style={{ fontSize: 30, fontWeight: 700, color: '#0f172a', fontFamily: 'monospace' }}>
                  14
                </span>
              ...
              <Progress percent={65} strokeColor="#4f46e5" size="small" style={{ margin: '8px 0 4px' }} />
          ...
          <Col xs={24} sm={12} lg={6}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                <span style={{ fontSize: 13, color: '#be123c', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                  Urgent Care Gaps
                </span>
                <span style={{ 
                  background: '#ffe4e6', 
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                <span style={{ fontSize: 30, fontWeight: 700, color: '#9f1239', fontFamily: 'monospace' }}>
                  7
                </span>
                <span style={{ 
                  background: '#fda4af', 
              ...
              <Text style={{ fontSize: 12, color: '#be123c', marginTop: 10, display: 'block', fontWeight: 500 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontSize: 15, fontWeight: 700, color: '#0f172a' }}>Priya Sharma</span>
                ...
                <div style={{ fontSize: 12, color: '#64748b', marginTop: 3 }}>
                  MRN: <strong>MRN-ONC-2026-001</strong> • ABHA: 91-5544-3322-1100 • Regimen: AC-T (Chemo Cycle 4 Overdue)
                </div>
                <div style={{ fontSize: 12, color: '#be123c', fontWeight: 600, marginTop: 2 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontSize: 15, fontWeight: 700, color: '#0f172a' }}>Rajesh Patel</span>
                ...
                <div style={{ fontSize: 12, color: '#64748b', marginTop: 3 }}>
                  MRN: <strong>MRN-ONC-2026-042</strong> • Histopathology TAT: 8 days (Breached 5-day TAT SLA)
                </div>
          ...
          <Card 
            title={
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <span style={{ fontSize: 12, color: '#64748b' }}>Updated Real-Time</span>
              </div>
            }
              ...
              renderItem={(item) => (
                <List.Item style={{ padding: '12px 0' }}>
                  <List.Item.Meta
                    ...
                    title={<span style={{ fontSize: 13, fontWeight: 500, color: '#1e293b' }}>{item.description}</span>}
                    description={<span style={{ fontSize: 11, color: '#94a3b8' }}>{item.time}</span>}
                  />
                  <Tag color={
                    item.type === 'alert' ? 'red' : 
